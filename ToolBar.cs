...
namespace GenForce
{
    public class ToolBar : Form
    {
        ...
        private ToolStripButton reset_Button;
        ...
        private void InitializeToolbar()
        {
            ...
            reset_Button = new ToolStripButton();

            toolStrip.Items.AddRange(new ToolStripItem[] { file_Button, edit_Button, reset_Button });
            ...
            file_Button.MouseEnter += ToolStripDropDownButton_MouseEnter;
            ...
            edit_Button.MouseEnter += ToolStripDropDownButton_MouseEnter;

            // reset table to default for whatever reason
        ...
        {
            if (sender is ToolStripDropDownButton dropdownButton)
            {
